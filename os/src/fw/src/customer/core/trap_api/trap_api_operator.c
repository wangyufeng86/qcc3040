                     ...
                     uint16 * recv_msg, uint16 recv_len_words)
{
    ...
    ipc_transaction(IPC_SIGNAL_ID_OPERATOR_MESSAGE, &op_msg, sizeof(op_msg),
                    IPC_SIGNAL_ID_OPERATOR_MESSAGE_RSP, &op_msg_rsp);
        ...
        uint16 * recv_msg, uint16 recv_len_words)
{
    ...
    ipc_transaction(IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_CONFIGURATION_GET, &send_prim, sizeof(send_prim),
                    IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_CONFIGURATION_GET_RSP, &resp_prim);
                               ...
                               uint16 n_sinks, Sink *sinklist)
{
    ...
    ipc_transaction(IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_PRESERVE, &send_prim, sizeof(send_prim),
                    IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_PRESERVE_RSP, &resp_prim);
    if (psrclist)
    {
        pfree(psrclist);
    }
                              ...
                              uint16 n_sinks, Sink *sinklist)
{
    ...
    send_prim.srclist = psrclist;
    send_prim.sinklist = psinklist;
    ipc_transaction(IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_RELEASE, &send_prim, sizeof(send_prim),
                    IPC_SIGNAL_ID_OPERATOR_FRAMEWORK_RELEASE_RSP, &resp_prim);
