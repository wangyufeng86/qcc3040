...
bool SdMmcSlotInit(bool init)
{
    ...
    ipc_transaction(IPC_SIGNAL_ID_SD_MMC_SLOT_INIT_REQ, &ipc_send_prim, sizeof(ipc_send_prim),
                    IPC_SIGNAL_ID_SD_MMC_SLOT_INIT_RSP, &ipc_recv_prim);
                   ...
                   uint32 start_block, uint32 blocks_count)
{
    ...
    ipc_transaction(IPC_SIGNAL_ID_SD_MMC_READ_DATA_REQ, &ipc_send_prim, sizeof(ipc_send_prim),
                    IPC_SIGNAL_ID_SD_MMC_READ_DATA_RSP, &ipc_recv_prim);
    return ipc_recv_prim.ret;
}
