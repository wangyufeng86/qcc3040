...
#define CHIP_REGISTER_HASH 0x27AE
...
enum apps_sys_debug_source_enum
{
   ...
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CPU_DM0 = (int)0x33,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CPU_DM1 = (int)0x34,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_SHARED1 = (int)0x35,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_SHARED2 = (int)0x36,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_TCM     = (int)0x37,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CACHE0  = (int)0x38,
   APPS_SYS_DEBUG_SOURCE_AUTO_SLEEP_CACHE1  = (int)0x39,
   APPS_SYS_DEBUG_SOURCE_TRACE              = (int)0x3A,
   APPS_SYS_DEBUG_SOURCE_VM_INTERCONNECT    = (int)0x3B,
   APPS_SYS_DEBUG_SOURCE_KALIMBA_DEBUG_MUX  = (int)0x3C,
   APPS_SYS_DEBUG_SOURCE_APU                = (int)0x3D,
   APPS_SYS_DEBUG_SOURCE_DEBUG_MUX          = (int)0x3E,
   APPS_SYS_DEBUG_SOURCE_MISC_TBUS_ARB      = (int)0x3F,
   APPS_SYS_DEBUG_SOURCE_EXT_REGS           = (int)0x40,
   APPS_SYS_DEBUG_SOURCE_TCM0_LOWER_MUX     = (int)0x41,
   APPS_SYS_DEBUG_SOURCE_TCM0_UPPER_MUX     = (int)0x42,
   APPS_SYS_DEBUG_SOURCE_TCM1_MUX           = (int)0x43,
   APPS_SYS_DEBUG_SOURCE_LAST               = (int)0x43,
   ...
   MAX_APPS_SYS_DEBUG_SOURCE                = (int)0x43
};
