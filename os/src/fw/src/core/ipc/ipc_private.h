 ...
 */
extern bool ipc_recv_handler(IPC_SIGNAL_ID blocking_id, void *blocking_msg);
 ...
 * \ingroup ipc_recv_impl
 */
extern void ipc_trap_api_handler(IPC_SIGNAL_ID id, const void *msg, uint16 msg_len);
...
#if defined(ENABLE_APPCMD_TEST_ID_IPC)
/**
