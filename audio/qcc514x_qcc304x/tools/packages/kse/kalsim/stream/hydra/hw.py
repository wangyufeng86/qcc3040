...
class StreamHw(KalsimStream):
    ...
    *backing=file*
    ...
    - *device* is the mapping between stream and endpoint, being the first hw source stream
      mapped to the first hw source endpoint and so on, sources and sinks mapping is independent
    ...
    *backing=data*
    ...
    def __init__(self, stream_type, **kwargs):
        ...
        super(StreamHw, self).__init__(stream_type, **params)
    ...
    def config(self, **kwargs):
        ...
        super(StreamHw, self).config(**kwargs)
