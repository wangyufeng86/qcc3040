...
class StreamI2s(StreamHw):
    ...
    *backing=file*
    ...
    - *device* is the mapping between stream and endpoint, being the first i2s source stream
      mapped to the first i2s source endpoint and so on, sources and sinks mapping is independent
