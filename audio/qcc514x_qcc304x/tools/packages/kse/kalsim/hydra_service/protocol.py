...
class HydraProtocol(object):
    ...
    def install_message_handler(self, handler, flt=None):
        return self._uut.message_register_handler([self._subsystem], callback=handler, flt=flt)
