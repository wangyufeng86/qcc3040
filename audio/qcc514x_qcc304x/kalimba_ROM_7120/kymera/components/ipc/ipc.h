 ...
 */
typedef IPC_STATUS (*IPC_SIGNAL_HANDLER)(PROC_ID_NUM remote_proc_id, uint16 signal_id, ipc_signal *sigind);

/*
 * Dedicated signal handler installed by function 'setup_static_signal'.
 */
typedef IPC_STATUS (*IPC_DEDICATED_SIGNAL_HANDLER)(PROC_ID_NUM remote_proc_id, uint16 signal_id, ipc_signal *sigind);
 ...
 */
extern IPC_STATUS ipc_register_comms(PROC_ID_NUM local_proc_id, uint16 framework_type, uint16 framework_version, IPC_INTERFACE_CALLBACK callback);
 ...
 */
extern IPC_STATUS ipc_setup_comms(PROC_ID_NUM remote_proc_id, IPC_MESSAGE_NOTIFICATION_HANDLER msg_callback, uint16 num_signals, IPC_SIGNAL_HANDLER sig_callback, uint16 *channel_id);
 ...
 */
extern IPC_STATUS ipc_start_processor(PROC_ID_NUM remote_proc_id, IPC_NVMEM_WIN_CONFIG_TYPE target);
 ...
 */
extern IPC_STATUS ipc_raise_signal(PROC_ID_NUM remote_proc_id, uint16 signal_id, ipc_signal *sigreq);
 ...
 */
extern IPC_STATUS ipc_activate_data_channel(uint16 data_channel_id, PROC_ID_NUM remote_proc_id, tCbuffer *cbuffer, bool create_cbuffer, uint16 param_size, void *params);
 ...
 */
extern IPC_STATUS ipc_set_shallow_sleep_status(PROC_ID_NUM proc_id, IPC_ACTIVE_STATE state, TIME wakeup_time);
 ...
 */
extern IPC_ACTIVE_STATE ipc_get_shallow_sleep_status(PROC_ID_NUM proc_id);
