 ...
 */
    ...
    /**
     * Unused 0x0079. Used to be PANIC_AUDIO_OCTET_BUFFER_UNSUPPORTED_PACKING
     * until octet_buffer was removed and replaced with cbuffer_ex.
     */
    ...
    /**
     * The cbuffer_ex limited implementation.
     * cbuffer_copy_<FORMAT>_ex does not support such a copy.
     * TODO not used yet, as there is no need for other than 16-bit unpacked,
     * so this is used as default;
     */
    PANIC_AUDIO_CBUFFER_EX_COPY_UNSUPPORTED_FORMAT = 0x008E,
    ...
    /* Unused 0x0094. Feel free to re-use. */
    ...
    /**
     * Unused 0x400E
     * Previously PANIC_AUDIO_ALREADY_CONNECTED_OPERATOR_TERMINAL
