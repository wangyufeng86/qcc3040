 ...
 *
 * \param buff Pointer to buffer
 * \return pointer to the newly allocated metadata_list object.
 * Note: Does NOT panic if not enough memory for allocation;
 *       Caller responsibility to check return value is valid.
 */
extern metadata_list *buff_metadata_enable(tCbuffer *buff);
