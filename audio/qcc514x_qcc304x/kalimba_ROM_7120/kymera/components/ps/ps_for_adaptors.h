 ...
 */
extern void ps_signal_shutdown(CONNECTION_LINK conn_id,
                               PS_SHUTDOWN_CALLBACK cback);
 ...
 * \param conn_id The connection ID (sender and recipient ID codes).
 */
extern void ps_register(CONNECTION_LINK conn_id);
 ...
 */
CONNECTION_LINK ps_get_conn_id(void);
