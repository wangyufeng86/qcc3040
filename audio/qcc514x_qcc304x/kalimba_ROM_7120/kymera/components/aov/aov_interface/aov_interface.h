...
#define TRIGGER_MESSAGE_MAX_LENGTH  56
 ...
 * \param op_data OPERATOR_DATA of the requesting operator client
 *
 * \param msg_len Length in words of the message contained in the trigger event.
 *                A message must be shorter than TRIGGER_MESSAGE_MAX_LENGTH.
 *
