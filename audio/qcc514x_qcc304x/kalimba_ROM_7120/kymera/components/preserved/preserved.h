...
/**
 * Obtain the preserved memory block
 *
 * Checks if the the code is running on primary process context or not,
 * and return the appropriate preserved structure.
 */
extern preserved_struct* get_preserved_struct(void);
