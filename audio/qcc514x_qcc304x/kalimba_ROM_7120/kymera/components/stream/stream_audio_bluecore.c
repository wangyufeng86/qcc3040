    ...
    switch (format)
    {
        case AUDIO_DATA_FORMAT_FIXP:
        {
            if (!endpoint->is_enabled)
            {
                ...
                success = cbops_mgr_append(endpoint->cbops, CBOPS_DC_REMOVE | CBOPS_SHIFT | CBOPS_RATEADJUST, nr_chans,
        ...
        case AUDIO_DATA_FORMAT_16_BIT:
        {
            if (!endpoint->is_enabled)
            {
                ...
                success = cbops_mgr_remove(endpoint->cbops, CBOPS_DC_REMOVE | CBOPS_SHIFT | CBOPS_RATEADJUST, nr_chans,
