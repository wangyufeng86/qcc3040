...
void sco_common_rcv_initialise(SCO_COMMON_RCV_OP_DATA* sco_rcv_op_data)
{
   ...
   if (sco_rcv_op_data->sco_rcv_parameters.plc100_struc != NULL)
    ...
    sco_rcv_op_data->sco_rcv_parameters.num_kicks_no_data = 0;
#ifdef INSTALL_PLC100
    ...
    sco_rcv_op_data->sco_rcv_parameters.md_status_ok = 0;
    sco_rcv_op_data->sco_rcv_parameters.md_status_crc = 0;
    sco_rcv_op_data->sco_rcv_parameters.md_status_nothing = 0;
    sco_rcv_op_data->sco_rcv_parameters.md_status_not_sched = 0;
#endif
}
