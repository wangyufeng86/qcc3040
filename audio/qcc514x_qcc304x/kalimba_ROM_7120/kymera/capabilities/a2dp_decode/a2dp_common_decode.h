...
extern void a2dp_decode_buffer_get_write_ptrs(A2DP_DECODER_PARAMS *decoder_data,
                                                stereo_ptrs *write_ptrs);
extern bool a2dp_decode_check_and_perform_fadeout(A2DP_DECODER_PARAMS *decoder_data,
