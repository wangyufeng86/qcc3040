...
.MODULE $M.aacdec.huffman_finish;
   ...
   Null = r3 - $aacdec.HUFFMAN_MASK;
   if NZ jump another_word;
       r3 = $aacdec.DATA_WIDTH_PER_WORD;
       jump update_bit_pos_and_readcount;
   another_word:
    // update get_bitpos from current value of r3
    r3 = SIGNDET r3;
    r3 = (DAWTH-1) - r3;
   update_bit_pos_and_readcount:
    ...
    r0 = I0 - r0;
    if NEG r0 = r0 + L0;
    r0 = r0 * ($aacdec.DATA_WIDTH_PER_WORD/ADDR_PER_WORD) (int);
...
.MODULE $M.aacdec.huffman_getpair;
   ...
   huff_loop:
      ...
      if NZ jump no_new_word_needed;
         ...
         r2 = M[I0, MK1];
         // set bitmask
         r3 = Null OR $aacdec.HUFFMAN_MASK;
      no_new_word_needed:
