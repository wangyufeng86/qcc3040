...
dbe_proc:
   ...
   r6 = r0 AND $M.DBE.CONFIG.BYPASS_BASS_OUTPUT_MIX;
   r5 = r0 AND $M.DBE.CONFIG.BYPASS_XOVER;
   M[r7 + $audio_proc.dbe.XOVER_BYPASS_FLAG] = r5;
   M[r7 + $audio_proc.dbe.MIXER_BYPASS_FLAG] = r6;
   ...
   M[r8 + $audio_proc.dbe.XOVER_BYPASS_FLAG] = r5;
   M[r8 + $audio_proc.dbe.MIXER_BYPASS_FLAG] = r6;
...
//#endif
   ...
   Null = M[r8 + $audio_proc.dbe.XOVER_BYPASS_FLAG];
   if Z jump xover_on_load_buffers;

xover_off_load_buffers:   
   // ************************************************
   ...
   I4 = r0;
   call $audio_proc.dbe.get_buffer_details;
   jump dbe_filters_process;

xover_on_load_buffers:   
   // ************************************************
   // load the input/output for filters_process()
   // set the size/base_addresses for the buffers
   // ************************************************
   r0 = M[r8 + $audio_proc.dbe.OUTPUT_WRITE_ADDR];
   I0 = r0;
