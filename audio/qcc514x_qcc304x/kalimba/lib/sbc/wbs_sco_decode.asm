...
$sco_decoder.wbs.process:
   ...
   // sticky_bfi is used to track overall frame packet status. 
   // especially for frames composed of multiple packets. eg. EV3 will have 2 packets per frame
...
decode_done:
   ...
   if Z jump no_output;
      // return sticky_bfi
      // we processed a good frame. Don't need to carry over sticky_bfi to the next frame
      // reset sticky_bfi

      r5 = M[r9 + $sbc.mem.WBS_STICKY_BFI_FIELD];
      M[r9 + $sbc.mem.WBS_STICKY_BFI_FIELD] = Null;
...
$sco_decoder.wbs.copy_frame:
   ...
   // r2 = #bytes to copy
    ...
    Null = r3 - r4;
    if Z jump in_phase;
        call $cbuffer.pack_unaligned_ex;
        jump cont_ret_regs;
    in_phase:
        call $cbuffer.pack_aligned_ex;
