...
.MODULE $M.cbops.reset;
   ...
   r1 = M[r8 + $cbops_c.cbops_graph_struct.MAX_OPS_FIELD];
   ...
   reset_loop:
      ...
      // check we haven't looped more times than MAX_OPS
...
$_cbops_process_data:
   ...
   // start profiling if enabled
    ...
    push r0;   // operator count      : M[SP-$CBOPS_COUNT] (at this point r0 is not relevant, just move SP)
   ...
   jp_amount_override_done:
    ...
    r0 = M[r0 + $cbops_c.cbops_graph_struct.MAX_OPS_FIELD];
    M[SP - $CBOPS_COUNT] = r0;
    amount_to_use_loop:
         // check we haven't looped more times than MAX_OPS
         r1 = M[SP - $CBOPS_COUNT];
