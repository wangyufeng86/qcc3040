...
static void request_file_data(void)
{
    ...
    bytes_to_request = (uint16)MIN(transfer_state.bytes_left,0xfffful);
    ...
    NOT_USED(bytes_requested); /* Only accessed in debug */
}
...
{
    uint16 len_words = (uint16)(data_len_bytes / 2) ;
