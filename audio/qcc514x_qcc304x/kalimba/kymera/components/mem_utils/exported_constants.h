...
/**
 * Queue a message to be sent to the current task when the constants previously
 * reserved are available
 *
 ...
 * \param context   The routing info for the message
 */
extern void external_constant_callback_when_available(OPERATOR_DATA *op_data,
                                                      void *source,
                                                      uint16 cmdId,
                                                      void *cmdMsg,
...
#define external_constant_callback_when_available(s,cmdId,cmdMsg,rinfo) ((void)0)
