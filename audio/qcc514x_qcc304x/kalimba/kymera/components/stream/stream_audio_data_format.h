...
typedef enum
{
    ...
    /** Generic format to signal encoded data.
     * It's interpreted as 32-bit packed if DATAFORMAT_32 is defined,
     * otherwise as 16-bit unpacked (AUDIO_DATA_FORMAT_16_BIT). */
