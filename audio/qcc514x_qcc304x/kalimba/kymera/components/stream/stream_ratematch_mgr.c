...
#define EP_IS_SHADOW(x) STREAM_EP_IS_SHADOW(x)
#else
#define EP_IS_SHADOW(x) FALSE
#endif
/****************************************************************************
                                     ...
                                     ENDPOINT_LIST *ep_list)
{
    ...
    while (ep != NULL)
    {
        ...
        {
            unsigned opid;
            if (EP_IS_SHADOW(ep->connected_to))
            {
...
static void find_graph_real_eps(unsigned start_id, ENDPOINT_LIST **real_eps)
{
    ...
    *real_eps = new_ep_list(MAX_REAL_EPS);
    ...
    if (start != NULL)
    {
        if (start->is_real)
        {
            if (EP_IS_SHADOW(start->connected_to))
            {
