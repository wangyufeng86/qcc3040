...
enum patch_index {
    ...
    patch_fn_rtp_decode_process_data_shared_patchpoint_index,
    ...
    patch_fn_swbs_plc_shared_patchpoint_index,
#endif
#if defined (INSTALL_OPERATOR_APTX_ADAPTIVE_ENCODE) || \
    ...
    patch_fn_hal_clock_streplus_audio_shared_patchpoint_index,
    patch_fn_clk_mgr_streplus_audio_shared_patchpoint_index,
