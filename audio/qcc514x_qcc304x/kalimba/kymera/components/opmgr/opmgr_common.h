...
/* set a pair of uint16 opmsg fields which is part of a unit32 value. The most significant 16bits ends with _ms and least significant ends with _ls */
#define OPMSG_CREATION_FIELD_SET_PAIR(msg, msgtype, field, value) \
           do {  \
               OPMSG_CREATION_FIELD_SET_FROM_OFFSET(msg, msgtype, field##_LS, 0, value & 0xffff ); \
               OPMSG_CREATION_FIELD_SET_FROM_OFFSET(msg, msgtype, field##_MS, 0, value >> 16 ); \
              } while(0)
