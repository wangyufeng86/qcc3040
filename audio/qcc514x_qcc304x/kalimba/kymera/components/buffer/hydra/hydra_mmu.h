...
/* Flag bit for buffer allocated in DM1 */
#define MMU_BUFF_DM1    (1<<1)
/* Flag bit for buffer allocated in DM2 */
#define MMU_BUFF_DM2    (1<<2)
#define MMU_HANDLE_UNKNOWN_FLAGS    0
...
#define MMU_UNPACKED_8BIT_MASK  (SAMPLE_SIZE_8BIT  << BUF_DESC_SAMP_SIZE_SHIFT)
#define MMU_UNPACKED_16BIT_MASK (SAMPLE_SIZE_16BIT << BUF_DESC_SAMP_SIZE_SHIFT)
#define MMU_UNPACKED_24BIT_MASK (SAMPLE_SIZE_24BIT << BUF_DESC_SAMP_SIZE_SHIFT)
#define MMU_UNPACKED_32BIT_MASK (SAMPLE_SIZE_32BIT << BUF_DESC_SAMP_SIZE_SHIFT)
