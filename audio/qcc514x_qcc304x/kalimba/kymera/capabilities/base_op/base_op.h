...
/**
 * \brief Disable the propagation of kicks to the operator.
 *
 * \param  op_data    Pointer to the operator structure.
 * \param  dir        Types of kicks to be ignored.
 *
 * \note This is useful for capabilities that process
 *       data periodicly.
 */
extern void base_op_stop_kicks(OPERATOR_DATA *op_data, STOP_KICK dir);
