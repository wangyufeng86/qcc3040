...
def parse_args(args):
    ...
    parser = argparse.ArgumentParser(description='Creates a file list with the source files ' +
                                     'from a folder of elf files')
...
def build_src_list_from_elf_files(elf_files, output_file, kcc_path):
    ...
    with open(output_file, 'w') as file:
        file.writelines(sorted(filename_map))
