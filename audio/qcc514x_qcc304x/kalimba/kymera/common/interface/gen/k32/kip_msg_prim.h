...
#define KIP_MSG_ID_IS_REQ(msg_id)                                       (((msg_id & 0x4000) == 0))
#define KIP_MSG_ID_TO_ADAPTOR_MSGID(msg_id)                             ((ADAPTOR_MSGID)(msg_id + AMSGID_KIP_START))
#define KIP_MSG_ID_RESP_MASK                                            (0x4000)
...
#define KIP_MSG_CREATE_OPERATOR_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_CREATE_OPERATOR_RES_CON_ID_GET(kip_msg_create_operator_res_ptr) ((kip_msg_create_operator_res_ptr)->_data[0])
#define KIP_MSG_CREATE_OPERATOR_RES_CON_ID_SET(kip_msg_create_operator_res_ptr, con_id) ((kip_msg_create_operator_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_CREATE_OPERATOR_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_CREATE_OPERATOR_RES_STATUS_GET(kip_msg_create_operator_res_ptr) ((kip_msg_create_operator_res_ptr)->_data[1])
#define KIP_MSG_CREATE_OPERATOR_RES_STATUS_SET(kip_msg_create_operator_res_ptr, status) ((kip_msg_create_operator_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_CREATE_OPERATOR_RES_CREATE(con_id, status, opid_or_reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(opid_or_reason_code)
#define KIP_MSG_CREATE_OPERATOR_RES_PACK(kip_msg_create_operator_res_ptr, con_id, status, opid_or_reason_code) \
    do { \
        (kip_msg_create_operator_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_create_operator_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_DESTROY_OPERATORS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_DESTROY_OPERATORS_RES_CON_ID_GET(kip_msg_destroy_operators_res_ptr) ((kip_msg_destroy_operators_res_ptr)->_data[0])
#define KIP_MSG_DESTROY_OPERATORS_RES_CON_ID_SET(kip_msg_destroy_operators_res_ptr, con_id) ((kip_msg_destroy_operators_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_DESTROY_OPERATORS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_DESTROY_OPERATORS_RES_STATUS_GET(kip_msg_destroy_operators_res_ptr) ((kip_msg_destroy_operators_res_ptr)->_data[1])
#define KIP_MSG_DESTROY_OPERATORS_RES_STATUS_SET(kip_msg_destroy_operators_res_ptr, status) ((kip_msg_destroy_operators_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_DESTROY_OPERATORS_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_DESTROY_OPERATORS_RES_PACK(kip_msg_destroy_operators_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_destroy_operators_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_destroy_operators_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_GET(kip_msg_file_mgr_release_file_res_ptr) ((kip_msg_file_mgr_release_file_res_ptr)->_data[0])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CON_ID_SET(kip_msg_file_mgr_release_file_res_ptr, con_id) ((kip_msg_file_mgr_release_file_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_GET(kip_msg_file_mgr_release_file_res_ptr) ((kip_msg_file_mgr_release_file_res_ptr)->_data[1])
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_STATUS_SET(kip_msg_file_mgr_release_file_res_ptr, status) ((kip_msg_file_mgr_release_file_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_CREATE(con_id, status, file_id) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(file_id)
#define KIP_MSG_FILE_MGR_RELEASE_FILE_RES_PACK(kip_msg_file_mgr_release_file_res_ptr, con_id, status, file_id) \
    do { \
        (kip_msg_file_mgr_release_file_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_file_mgr_release_file_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_GET_MEM_USAGE_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_GET_MEM_USAGE_RES_CON_ID_GET(kip_msg_get_mem_usage_res_ptr) ((kip_msg_get_mem_usage_res_ptr)->_data[0])
#define KIP_MSG_GET_MEM_USAGE_RES_CON_ID_SET(kip_msg_get_mem_usage_res_ptr, con_id) ((kip_msg_get_mem_usage_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_GET_MEM_USAGE_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_GET_MEM_USAGE_RES_STATUS_GET(kip_msg_get_mem_usage_res_ptr) ((kip_msg_get_mem_usage_res_ptr)->_data[1])
#define KIP_MSG_GET_MEM_USAGE_RES_STATUS_SET(kip_msg_get_mem_usage_res_ptr, status) ((kip_msg_get_mem_usage_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_GET_MEM_USAGE_RES_CREATE(con_id, status, heap_size, heap_current, heap_min, pool_size, pool_current, pool_min) \
    (uint16)(con_id), \
    (uint16)(status), \
    ...
    (uint16)((pool_min) >> 16)
#define KIP_MSG_GET_MEM_USAGE_RES_PACK(kip_msg_get_mem_usage_res_ptr, con_id, status, heap_size, heap_current, heap_min, pool_size, pool_current, pool_min) \
    do { \
        (kip_msg_get_mem_usage_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_get_mem_usage_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_CON_ID_GET(kip_msg_metadata_channel_activated_res_ptr) ((kip_msg_metadata_channel_activated_res_ptr)->_data[0])
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_CON_ID_SET(kip_msg_metadata_channel_activated_res_ptr, con_id) ((kip_msg_metadata_channel_activated_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_STATUS_GET(kip_msg_metadata_channel_activated_res_ptr) ((kip_msg_metadata_channel_activated_res_ptr)->_data[1])
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_STATUS_SET(kip_msg_metadata_channel_activated_res_ptr, status) ((kip_msg_metadata_channel_activated_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_CREATE(con_id, status, channel_id) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(channel_id)
#define KIP_MSG_METADATA_CHANNEL_ACTIVATED_RES_PACK(kip_msg_metadata_channel_activated_res_ptr, con_id, status, channel_id) \
    do { \
        (kip_msg_metadata_channel_activated_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_metadata_channel_activated_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_CON_ID_GET(kip_msg_operator_get_endpoint_res_ptr) ((kip_msg_operator_get_endpoint_res_ptr)->_data[0])
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_CON_ID_SET(kip_msg_operator_get_endpoint_res_ptr, con_id) ((kip_msg_operator_get_endpoint_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_STATUS_GET(kip_msg_operator_get_endpoint_res_ptr) ((kip_msg_operator_get_endpoint_res_ptr)->_data[1])
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_STATUS_SET(kip_msg_operator_get_endpoint_res_ptr, status) ((kip_msg_operator_get_endpoint_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_CREATE(con_id, status, opepid) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(opepid)
#define KIP_MSG_OPERATOR_GET_ENDPOINT_RES_PACK(kip_msg_operator_get_endpoint_res_ptr, con_id, status, opepid) \
    do { \
        (kip_msg_operator_get_endpoint_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_operator_get_endpoint_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_CON_ID_GET(kip_msg_operator_license_query_res_ptr) ((kip_msg_operator_license_query_res_ptr)->_data[0])
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_CON_ID_SET(kip_msg_operator_license_query_res_ptr, con_id) ((kip_msg_operator_license_query_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_STATUS_GET(kip_msg_operator_license_query_res_ptr) ((kip_msg_operator_license_query_res_ptr)->_data[1])
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_STATUS_SET(kip_msg_operator_license_query_res_ptr, status) ((kip_msg_operator_license_query_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_CREATE(con_id, status, length, payload) \
    (uint16)(con_id), \
    (uint16)(status), \
    ...
    (uint16)((payload) & 0xffff), \
    (uint16)((payload) >> 16)
#define KIP_MSG_OPERATOR_LICENSE_QUERY_RES_PACK(kip_msg_operator_license_query_res_ptr, con_id, status, length, payload) \
    do { \
        (kip_msg_operator_license_query_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_operator_license_query_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_OPERATOR_MESSAGE_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_OPERATOR_MESSAGE_RES_CON_ID_GET(kip_msg_operator_message_res_ptr) ((kip_msg_operator_message_res_ptr)->_data[0])
#define KIP_MSG_OPERATOR_MESSAGE_RES_CON_ID_SET(kip_msg_operator_message_res_ptr, con_id) ((kip_msg_operator_message_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_OPERATOR_MESSAGE_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_OPERATOR_MESSAGE_RES_STATUS_GET(kip_msg_operator_message_res_ptr) ((kip_msg_operator_message_res_ptr)->_data[1])
#define KIP_MSG_OPERATOR_MESSAGE_RES_STATUS_SET(kip_msg_operator_message_res_ptr, status) ((kip_msg_operator_message_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_OPERATOR_MESSAGE_RES_CREATE(con_id, status, opid_or_reason_code, response) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(opid_or_reason_code), \
    (uint16)(response)
#define KIP_MSG_OPERATOR_MESSAGE_RES_PACK(kip_msg_operator_message_res_ptr, con_id, status, opid_or_reason_code, response) \
    do { \
        (kip_msg_operator_message_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_operator_message_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_OPLIST_CMD_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_OPLIST_CMD_RES_CON_ID_GET(kip_msg_oplist_cmd_res_ptr) ((kip_msg_oplist_cmd_res_ptr)->_data[0])
#define KIP_MSG_OPLIST_CMD_RES_CON_ID_SET(kip_msg_oplist_cmd_res_ptr, con_id) ((kip_msg_oplist_cmd_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_OPLIST_CMD_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_OPLIST_CMD_RES_STATUS_GET(kip_msg_oplist_cmd_res_ptr) ((kip_msg_oplist_cmd_res_ptr)->_data[1])
#define KIP_MSG_OPLIST_CMD_RES_STATUS_SET(kip_msg_oplist_cmd_res_ptr, status) ((kip_msg_oplist_cmd_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_OPLIST_CMD_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_OPLIST_CMD_RES_PACK(kip_msg_oplist_cmd_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_oplist_cmd_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_oplist_cmd_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_CON_ID_GET(kip_msg_p1_run_until_preproc_operators_res_ptr) ((kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[0])
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_CON_ID_SET(kip_msg_p1_run_until_preproc_operators_res_ptr, con_id) ((kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_STATUS_GET(kip_msg_p1_run_until_preproc_operators_res_ptr) ((kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[1])
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_STATUS_SET(kip_msg_p1_run_until_preproc_operators_res_ptr, status) ((kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_P1_RUN_UNTIL_PREPROC_OPERATORS_RES_PACK(kip_msg_p1_run_until_preproc_operators_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_p1_run_until_preproc_operators_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_PS_DELETE_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_PS_DELETE_RES_CON_ID_GET(kip_msg_ps_delete_res_ptr) ((kip_msg_ps_delete_res_ptr)->_data[0])
#define KIP_MSG_PS_DELETE_RES_CON_ID_SET(kip_msg_ps_delete_res_ptr, con_id) ((kip_msg_ps_delete_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_PS_DELETE_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_PS_DELETE_RES_STATUS_GET(kip_msg_ps_delete_res_ptr) ((kip_msg_ps_delete_res_ptr)->_data[1])
#define KIP_MSG_PS_DELETE_RES_STATUS_SET(kip_msg_ps_delete_res_ptr, status) ((kip_msg_ps_delete_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_DELETE_RES_CREATE(con_id, status, Key_Id) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)((Key_Id) & 0xffff), \
    (uint16)((Key_Id) >> 16)
#define KIP_MSG_PS_DELETE_RES_PACK(kip_msg_ps_delete_res_ptr, con_id, status, Key_Id) \
    do { \
        (kip_msg_ps_delete_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_ps_delete_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_PS_READ_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_PS_READ_RES_CON_ID_GET(kip_msg_ps_read_res_ptr) ((kip_msg_ps_read_res_ptr)->_data[0])
#define KIP_MSG_PS_READ_RES_CON_ID_SET(kip_msg_ps_read_res_ptr, con_id) ((kip_msg_ps_read_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_PS_READ_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_PS_READ_RES_STATUS_GET(kip_msg_ps_read_res_ptr) ((kip_msg_ps_read_res_ptr)->_data[1])
#define KIP_MSG_PS_READ_RES_STATUS_SET(kip_msg_ps_read_res_ptr, status) ((kip_msg_ps_read_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_READ_RES_CREATE(con_id, status, Total_Len, data) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Total_Len), \
    (uint16)(data)
#define KIP_MSG_PS_READ_RES_PACK(kip_msg_ps_read_res_ptr, con_id, status, Total_Len, data) \
    do { \
        (kip_msg_ps_read_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_ps_read_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_PS_WRITE_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_PS_WRITE_RES_CON_ID_GET(kip_msg_ps_write_res_ptr) ((kip_msg_ps_write_res_ptr)->_data[0])
#define KIP_MSG_PS_WRITE_RES_CON_ID_SET(kip_msg_ps_write_res_ptr, con_id) ((kip_msg_ps_write_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_PS_WRITE_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_PS_WRITE_RES_STATUS_GET(kip_msg_ps_write_res_ptr) ((kip_msg_ps_write_res_ptr)->_data[1])
#define KIP_MSG_PS_WRITE_RES_STATUS_SET(kip_msg_ps_write_res_ptr, status) ((kip_msg_ps_write_res_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_PS_WRITE_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PS_WRITE_RES_CREATE(con_id, status) \
    (uint16)(con_id), \
    (uint16)(status)
#define KIP_MSG_PS_WRITE_RES_PACK(kip_msg_ps_write_res_ptr, con_id, status) \
    do { \
        (kip_msg_ps_write_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_ps_write_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
    } while (0)
...
#define KIP_MSG_PUBLISH_FAULT_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_PUBLISH_FAULT_RES_STATUS_GET(kip_msg_publish_fault_res_ptr) ((kip_msg_publish_fault_res_ptr)->_data[1])
#define KIP_MSG_PUBLISH_FAULT_RES_STATUS_SET(kip_msg_publish_fault_res_ptr, status) ((kip_msg_publish_fault_res_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_PUBLISH_FAULT_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_PUBLISH_FAULT_RES_CREATE(con_id, status) \
    (uint16)(con_id), \
    (uint16)(status)
#define KIP_MSG_PUBLISH_FAULT_RES_PACK(kip_msg_publish_fault_res_ptr, con_id, status) \
    do { \
        (kip_msg_publish_fault_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_publish_fault_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
    } while (0)
...
#define KIP_MSG_RESET_OPERATORS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_RESET_OPERATORS_RES_CON_ID_GET(kip_msg_reset_operators_res_ptr) ((kip_msg_reset_operators_res_ptr)->_data[0])
#define KIP_MSG_RESET_OPERATORS_RES_CON_ID_SET(kip_msg_reset_operators_res_ptr, con_id) ((kip_msg_reset_operators_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_RESET_OPERATORS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_RESET_OPERATORS_RES_STATUS_GET(kip_msg_reset_operators_res_ptr) ((kip_msg_reset_operators_res_ptr)->_data[1])
#define KIP_MSG_RESET_OPERATORS_RES_STATUS_SET(kip_msg_reset_operators_res_ptr, status) ((kip_msg_reset_operators_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_RESET_OPERATORS_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_RESET_OPERATORS_RES_PACK(kip_msg_reset_operators_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_reset_operators_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_reset_operators_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_RES_STRUC_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_RES_STRUC_CON_ID_GET(kip_msg_res_struc_ptr) ((kip_msg_res_struc_ptr)->_data[0])
#define KIP_MSG_RES_STRUC_CON_ID_SET(kip_msg_res_struc_ptr, con_id) ((kip_msg_res_struc_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_RES_STRUC_STATUS_WORD_OFFSET (1)
#define KIP_MSG_RES_STRUC_STATUS_GET(kip_msg_res_struc_ptr) ((kip_msg_res_struc_ptr)->_data[1])
#define KIP_MSG_RES_STRUC_STATUS_SET(kip_msg_res_struc_ptr, status) ((kip_msg_res_struc_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_RES_STRUC_CREATE(con_id, status, data) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(data)
#define KIP_MSG_RES_STRUC_PACK(kip_msg_res_struc_ptr, con_id, status, data) \
    do { \
        (kip_msg_res_struc_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_res_struc_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_SET_SYSTEM_KEY_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_SET_SYSTEM_KEY_RES_STATUS_GET(kip_msg_set_system_key_res_ptr) ((kip_msg_set_system_key_res_ptr)->_data[1])
#define KIP_MSG_SET_SYSTEM_KEY_RES_STATUS_SET(kip_msg_set_system_key_res_ptr, status) ((kip_msg_set_system_key_res_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_SET_SYSTEM_KEY_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_SET_SYSTEM_KEY_RES_CREATE(con_id, status) \
    (uint16)(con_id), \
    (uint16)(status)
#define KIP_MSG_SET_SYSTEM_KEY_RES_PACK(kip_msg_set_system_key_res_ptr, con_id, status) \
    do { \
        (kip_msg_set_system_key_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_set_system_key_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
    } while (0)
...
#define KIP_MSG_START_OPERATORS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_START_OPERATORS_RES_CON_ID_GET(kip_msg_start_operators_res_ptr) ((kip_msg_start_operators_res_ptr)->_data[0])
#define KIP_MSG_START_OPERATORS_RES_CON_ID_SET(kip_msg_start_operators_res_ptr, con_id) ((kip_msg_start_operators_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_START_OPERATORS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_START_OPERATORS_RES_STATUS_GET(kip_msg_start_operators_res_ptr) ((kip_msg_start_operators_res_ptr)->_data[1])
#define KIP_MSG_START_OPERATORS_RES_STATUS_SET(kip_msg_start_operators_res_ptr, status) ((kip_msg_start_operators_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_START_OPERATORS_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_START_OPERATORS_RES_PACK(kip_msg_start_operators_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_start_operators_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_start_operators_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_STOP_OPERATORS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STOP_OPERATORS_RES_CON_ID_GET(kip_msg_stop_operators_res_ptr) ((kip_msg_stop_operators_res_ptr)->_data[0])
#define KIP_MSG_STOP_OPERATORS_RES_CON_ID_SET(kip_msg_stop_operators_res_ptr, con_id) ((kip_msg_stop_operators_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STOP_OPERATORS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_STOP_OPERATORS_RES_STATUS_GET(kip_msg_stop_operators_res_ptr) ((kip_msg_stop_operators_res_ptr)->_data[1])
#define KIP_MSG_STOP_OPERATORS_RES_STATUS_SET(kip_msg_stop_operators_res_ptr, status) ((kip_msg_stop_operators_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STOP_OPERATORS_RES_CREATE(con_id, status, Count, reason_code) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count), \
    (uint16)(reason_code)
#define KIP_MSG_STOP_OPERATORS_RES_PACK(kip_msg_stop_operators_res_ptr, con_id, status, Count, reason_code) \
    do { \
        (kip_msg_stop_operators_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stop_operators_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_STREAM_CONNECT_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STREAM_CONNECT_RES_CON_ID_GET(kip_msg_stream_connect_res_ptr) ((kip_msg_stream_connect_res_ptr)->_data[0])
#define KIP_MSG_STREAM_CONNECT_RES_CON_ID_SET(kip_msg_stream_connect_res_ptr, con_id) ((kip_msg_stream_connect_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STREAM_CONNECT_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_STREAM_CONNECT_RES_STATUS_GET(kip_msg_stream_connect_res_ptr) ((kip_msg_stream_connect_res_ptr)->_data[1])
#define KIP_MSG_STREAM_CONNECT_RES_STATUS_SET(kip_msg_stream_connect_res_ptr, status) ((kip_msg_stream_connect_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CONNECT_RES_CREATE(con_id, status, Transform_ID) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Transform_ID)
#define KIP_MSG_STREAM_CONNECT_RES_PACK(kip_msg_stream_connect_res_ptr, con_id, status, Transform_ID) \
    do { \
        (kip_msg_stream_connect_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stream_connect_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CON_ID_GET(kip_msg_stream_create_endpoints_res_ptr) ((kip_msg_stream_create_endpoints_res_ptr)->_data[0])
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CON_ID_SET(kip_msg_stream_create_endpoints_res_ptr, con_id) ((kip_msg_stream_create_endpoints_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_STATUS_GET(kip_msg_stream_create_endpoints_res_ptr) ((kip_msg_stream_create_endpoints_res_ptr)->_data[1])
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_STATUS_SET(kip_msg_stream_create_endpoints_res_ptr, status) ((kip_msg_stream_create_endpoints_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_CREATE(con_id, status, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Channel_ID), \
    (uint16)(Buffer_size), \
    ...
    (uint16)((tinfo_period) >> 16), \
    (uint16)(flags)
#define KIP_MSG_STREAM_CREATE_ENDPOINTS_RES_PACK(kip_msg_stream_create_endpoints_res_ptr, con_id, status, Channel_ID, Buffer_size, tinfo_block_size, tinfo_period, flags) \
    do { \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stream_create_endpoints_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_CON_ID_GET(kip_msg_stream_destroy_endpoints_res_ptr) ((kip_msg_stream_destroy_endpoints_res_ptr)->_data[0])
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_CON_ID_SET(kip_msg_stream_destroy_endpoints_res_ptr, con_id) ((kip_msg_stream_destroy_endpoints_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_STATUS_GET(kip_msg_stream_destroy_endpoints_res_ptr) ((kip_msg_stream_destroy_endpoints_res_ptr)->_data[1])
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_STATUS_SET(kip_msg_stream_destroy_endpoints_res_ptr, status) ((kip_msg_stream_destroy_endpoints_res_ptr)->_data[1] = (uint16)(status))
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_WORD_SIZE (2)
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_CREATE(con_id, status) \
    (uint16)(con_id), \
    (uint16)(status)
#define KIP_MSG_STREAM_DESTROY_ENDPOINTS_RES_PACK(kip_msg_stream_destroy_endpoints_res_ptr, con_id, status) \
    do { \
        (kip_msg_stream_destroy_endpoints_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stream_destroy_endpoints_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
    } while (0)
...
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_CON_ID_GET(kip_msg_stream_transform_disconnect_res_ptr) ((kip_msg_stream_transform_disconnect_res_ptr)->_data[0])
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_CON_ID_SET(kip_msg_stream_transform_disconnect_res_ptr, con_id) ((kip_msg_stream_transform_disconnect_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_STATUS_GET(kip_msg_stream_transform_disconnect_res_ptr) ((kip_msg_stream_transform_disconnect_res_ptr)->_data[1])
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_STATUS_SET(kip_msg_stream_transform_disconnect_res_ptr, status) ((kip_msg_stream_transform_disconnect_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_CREATE(con_id, status, Count) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count)
#define KIP_MSG_STREAM_TRANSFORM_DISCONNECT_RES_PACK(kip_msg_stream_transform_disconnect_res_ptr, con_id, status, Count) \
    do { \
        (kip_msg_stream_transform_disconnect_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_stream_transform_disconnect_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
...
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_CON_ID_WORD_OFFSET (0)
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_CON_ID_GET(kip_msg_transform_list_remove_entry_res_ptr) ((kip_msg_transform_list_remove_entry_res_ptr)->_data[0])
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_CON_ID_SET(kip_msg_transform_list_remove_entry_res_ptr, con_id) ((kip_msg_transform_list_remove_entry_res_ptr)->_data[0] = (uint16)(con_id))
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_STATUS_WORD_OFFSET (1)
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_STATUS_GET(kip_msg_transform_list_remove_entry_res_ptr) ((kip_msg_transform_list_remove_entry_res_ptr)->_data[1])
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_STATUS_SET(kip_msg_transform_list_remove_entry_res_ptr, status) ((kip_msg_transform_list_remove_entry_res_ptr)->_data[1] = (uint16)(status))
...
/*lint -e(773) allow unparenthesized*/
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_CREATE(con_id, status, Count) \
    (uint16)(con_id), \
    (uint16)(status), \
    (uint16)(Count)
#define KIP_MSG_TRANSFORM_LIST_REMOVE_ENTRY_RES_PACK(kip_msg_transform_list_remove_entry_res_ptr, con_id, status, Count) \
    do { \
        (kip_msg_transform_list_remove_entry_res_ptr)->_data[0] = (uint16)((uint16)(con_id)); \
        (kip_msg_transform_list_remove_entry_res_ptr)->_data[1] = (uint16)((uint16)(status)); \
