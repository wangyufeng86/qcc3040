...
/*******************************************************************************
 ...
 VALUES
    ...
    TTP_RTP_SEQ         - This  message is sent by the RTP DECODE operator to
                          notify the time to play values and the RTP sequence
                          number.
...
/*******************************************************************************
  ...
  MEMBERS
    ...
    compatibility     - The compatibility field will have a setting of 0=R1.1,
                        and 1=R2.0.
...
/*lint -e(773) allow unparenthesized*/
#define OPMSG_APTX_ADAPTIVE_ENC_SET_ENCODING_PARAMS_CREATE(message_id, primary_profile, secondary_profile, channels, bit_rate, sample_rate, compatibility) \
    (uint16)(message_id), \
...
#define OPMSG_APTX_ADAPTIVE_ENC_SET_ENCODING_PARAMS_PACK(opmsg_aptx_adaptive_enc_set_encoding_params_ptr, message_id, primary_profile, secondary_profile, channels, bit_rate, sample_rate, compatibility) \
    do { \
