...
def launch_audio_kse_env(devkit_root, kse_path, fw_name, kalsim_name, enable_debug, scripts, platform, patch_bundle, bundle_path, acat_path):
    ...
    cmd = cmd + " --acat_path {}".format(os.path.join(acat_path, "ACAT"))
    cmd = cmd + " --acat_use"
    if bundle_path != "":
