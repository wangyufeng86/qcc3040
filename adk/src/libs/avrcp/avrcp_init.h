...
*
*  bd_addr                  BT address to find
*  search_connection_dir    if TRUE, will only match tasks matching the
*                           specified connection direction
*  incoming                 The connection direction to match.  Parameter
*                           ignored if search_connection_dir is FALSE.
*/
