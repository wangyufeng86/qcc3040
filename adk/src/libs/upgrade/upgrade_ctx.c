...
/****************************************************************************
NAME
    UpgradeCtxGetPeerDFUStartStatus
...
{
    return &upgradeCtx->peerDfuStartStatus;
}

/****************************************************************************
NAME
    UpgradeCtxSetPeerDFUStartStatus

DESCRIPTION
    Sets the peerDfuStartStatus in the upgrade context.
*/

void UpgradeCtxSetPeerDFUStartStatus(uint16 peer_dfu_start_status)
{
    upgradeCtx->peerDfuStartStatus = peer_dfu_start_status;
}
