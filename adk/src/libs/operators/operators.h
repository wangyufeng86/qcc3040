...
/****************************************************************************
DESCRIPTION
    Set the ANC factory gain to configure the Adaptive ANC capability
    Coarse factory gain (0-15) followed by fine factory gain (0-255)
*/
...
/****************************************************************************
DESCRIPTION
    Get the gain CALCULATED by the adaptive gain algorithm
    Clients are expected to use OperatorsCreateGetParamsData() API to allocate get_params_data
*/
void OperatorsAdaptiveAncGetCalculatedGain(Operator op, get_params_data_t* get_params_data);

/****************************************************************************
DESCRIPTION
    Get the CURRENT (warm) gain set by Adaptive ANC in HW
    Clients are expected to use OperatorsCreateGetParamsData() API to allocate get_params_data
*/
