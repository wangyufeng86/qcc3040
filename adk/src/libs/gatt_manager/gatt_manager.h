...
typedef enum __gatt_manager_message_id
{
    ...
    GATT_MANAGER_CONNECT_AS_CENTRAL_CFM,
    GATT_MANAGER_REMOTE_SERVER_NOTIFICATION_IND,
    GATT_MANAGER_REMOTE_SERVER_INDICATION_IND,
    GATT_MANAGER_CONNECT_AS_PERIPHERAL_CFM,
    GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM,
    ...
    GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM,
...
/*!
    @brief Start BLE Advertising and wait for a client device to discover and
           ...
           GATT_MANAGER_CONNECT_AS_PERIPHERAL_CFM  indicating failure or when a
    ...
    @return void
*/
void GattManagerConnectAsPeripheral (
        Task task,
...
/*!
    @brief Sent if a BR/EDR device attempts to connect GATT or
           a BLE connection is established without use of the 
           gatt or gatt_manager API
...
*/
typedef GATT_CONNECT_IND_T GATT_MANAGER_CONNECT_IND_T;

/*!
    @brief Respond to GATT_MANAGER_CONNECT_IND
    ...
    @return void
*/
void GattManagerConnectResponse(uint16 cid, uint16 flags, bool accept);

/*!
    @brief Sent in response to a GattManagerConnectAsPeripheral().
    ...
    @param mtu Connection MTU.
*/
typedef GATT_CONNECT_CFM_T GATT_MANAGER_CONNECT_AS_PERIPHERAL_CFM_T;

/*!
    @brief Cancel the BLE Advertising after the function
           GattManagerConnectAsPeripheral() was called, this will stop BLE
           Advertising.

           A GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM message shall be sent
           indicating the outcome of the request.

    @return void
*/
void GattManagerCancelConnectAsPeripheral(void);

/*!
    @brief Sent in response to GattManagerCancelConnectAsPeripheral().

    @param status Indicates the outcome of the request.
*/
typedef struct PACK_STRUCT __GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM
{
    gatt_manager_status_t   status;
} GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM_T;
...
/*!
    @brief Attempt connection to a remote server device.
           ...
           A GATT_MANAGER_CONNECT_AS_CENTRAL_CFM message will be returned once
    ...
    @return void.
*/
void GattManagerConnectAsCentral(const Task task, const typed_bdaddr *taddr, gatt_connection_type conn_type, bool conn_timeout);


/*!
    @brief Sent in response to a GattManagerConnectAsCentral().
    ...
    @param mtu Connection MTU.
*/
typedef GATT_CONNECT_CFM_T GATT_MANAGER_CONNECT_AS_CENTRAL_CFM_T;


/*!
    @brief Cancel the BLE connection after the function
           GattManagerConnectAsCentral() was called.

           A GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM_T message shall be sent
           indicating the outcome of the request.

           This message will be sent to the task supplied as well as the
           task associated with the connection in GattManagerConnectAsCentral().

    @param  Task to receive cancel confirm. Confirm will also be sent to the task 
            specified in GattManagerConnectAsCentral if different.

    @return void
*/
void GattManagerCancelConnectAsCentral(Task task);


/*!
    @brief Sent in response to GattManagerCancelConnectAsCentral().
    ...
    @param status Indicates the outcome of the request. 
*/
typedef struct PACK_STRUCT __GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM
{
    gatt_manager_status_t   status;

} GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM_T;
...
/* Defines for backward compatibility with old function/message names */

#define GATT_MANAGER_REMOTE_SERVER_CONNECT_CFM          GATT_MANAGER_CONNECT_AS_CENTRAL_CFM
#define GATT_MANAGER_REMOTE_CLIENT_CONNECT_CFM          GATT_MANAGER_CONNECT_AS_PERIPHERAL_CFM
#define GATT_MANAGER_CANCEL_REMOTE_CLIENT_CONNECT_CFM   GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM
#define GATT_MANAGER_REMOTE_CLIENT_CONNECT_IND          GATT_MANAGER_CONNECT_IND
#define GATT_MANAGER_CANCEL_REMOTE_SERVER_CONNECT_CFM   GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM

#define GATT_MANAGER_REMOTE_CLIENT_CONNECT_IND_T        GATT_MANAGER_CONNECT_IND_T
#define GATT_MANAGER_REMOTE_CLIENT_CONNECT_CFM_T        GATT_MANAGER_CONNECT_AS_PERIPHERAL_CFM_T
#define __GATT_MANAGER_CANCEL_REMOTE_CLIENT_CONNECT_CFM __GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM
#define GATT_MANAGER_CANCEL_REMOTE_CLIENT_CONNECT_CFM_T GATT_MANAGER_CANCEL_CONNECT_AS_PERIPHERAL_CFM_T
#define GATT_MANAGER_REMOTE_SERVER_CONNECT_CFM_T        GATT_MANAGER_CONNECT_AS_CENTRAL_CFM_T
#define __GATT_MANAGER_CANCEL_REMOTE_SERVER_CONNECT_CFM __GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM
#define GATT_MANAGER_CANCEL_REMOTE_SERVER_CONNECT_CFM_T GATT_MANAGER_CANCEL_CONNECT_AS_CENTRAL_CFM_T

#define GattManagerRemoteClientConnectResponse(cid, flags, accept) \
    GattManagerConnectResponse(cid, flags, accept)

#define GattManagerWaitForRemoteClient(task, taddr, conn_type) \
    GattManagerConnectAsPeripheral(task, taddr, conn_type)

#define GattManagerCancelWaitForRemoteClient() \
    GattManagerCancelConnectAsPeripheral()

#define GattManagerConnectToRemoteServer(task, taddr, conn_type, conn_timeout) \
    GattManagerConnectAsCentral(task, taddr, conn_type, conn_timeout)

#define GattManagerCancelConnectToRemoteServer(task) \
    GattManagerCancelConnectAsCentral(task)
